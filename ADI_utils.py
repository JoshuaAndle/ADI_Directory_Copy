...
from ADI_occupancy import get_rectangular_occupancy_map
#from occupancy import NYGC_rectangular_occupancy_map
from ADI_occupancy import get_circle_occupancy_map, log_circle_occupancy_map
...
def preprocess(data_dir):
    ...
    ### These aren't called because instead the data is stored as files obs and pred during the ADI_preprocess script    

# ### Identical to data_process method
...
#  ### Scales the coordinates to pixel values, given the frame's dimensions in pixels
...
### Takes the NxFx4 tensor of trajectory observations and extracts the coordinates into an NxFx2 where N is pedestrian index and F is obs_frame_num
...
### Same as for person_model_input, but done on the pred tensor
